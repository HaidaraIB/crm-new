...
const TheApp = () => {
    ...
    if (pathname === '/verify-phone' || currentPage === 'VerifyPhone') {
    ...
    return (
        <div className={`flex h-full min-h-0 overflow-hidden ${language === 'ar' ? 'font-arabic' : 'font-sans'} bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-300`}>
            ...
            <AddCallModal />
            <AddVisitModal />
            {fieldVisitsAllowed && <AddFieldVisitModal />}
            <AssignLeadModal />
            <FilterDrawer />
            <CallsFilterDrawer />
