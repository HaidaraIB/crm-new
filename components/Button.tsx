...
type ButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & { children?: ReactNode, onClick?: () => void, className?: string, variant?: 'primary' | 'secondary' | 'ghost' | 'danger', disabled?: boolean, loading?: boolean, type?: 'button' | 'submit' | 'reset', title?: string };
export const Button = ({ children, onClick, className = '', variant = 'primary', disabled, loading, type = 'button', title, ...props }: ButtonProps) => {
