                ...
                {featureKeys.length === 0 ? (
                    ...
                    <div className="flex flex-wrap gap-2">
                        {featureKeys.map((k) => (
                            <span
                                key={k}
                                className="inline-flex items-center gap-1 rounded-full border border-primary-500/40 bg-primary-50/90 px-2.5 py-1 text-xs text-primary-800 dark:border-primary-400/60 dark:bg-primary-950/70 dark:text-primary-50"
                            >
                                <svg
                                    className="w-3.5 h-3.5 shrink-0 text-primary-600 dark:text-primary-200"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                    aria-hidden
