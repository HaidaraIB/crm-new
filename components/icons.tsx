...
export const HandshakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" shapeRendering="geometricPrecision" {...props}>
        <path d="m11 17 2 2a1 1 0 1 0 3-3" />
        <path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.07 2.83l.22.22" />
        <path d="m7 21 2.5-2.5a1 1 0 1 0-3-3l-3.88-3.88a3 3 0 0 1 0-4.24l.88-.88a1 1 0 1 0-3-3l-2.81 2.81a5.79 5.79 0 0 0 2.83 7.07l.22.22" />
    </svg>
);
...
/** Company media library — folder of shared files */
...
/** Down arrow with baseline (tap-to-download / load affordance). */
export const ArrowDownToLineIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 17V3" />
...
/** Overflow / “more actions” (vertical kebab). */
...
/** Declined / hang-up phone (rotated down like WhatsApp end-call). */
export const PhoneHangupIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
/** Muted microphone for in-call controls. */
...
/** Desk / PBX outbound dial — phone with outgoing arrow (distinct from tel: link). */
export const PbxDialIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** Map pin — site / client visit (distinct from deal handshake icon). */
...
/** Briefcase — deal / commercial action (distinct from visit map pin). */
...
/** Custom Lead API — Integrations sidebar */
export const CodeBracketsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** Back / start-direction arrow — mirrors in RTL so “back” points toward the reading start. */
export const ArrowLeftIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg
        ...
        className={['rtl:rotate-180', className].filter(Boolean).join(' ')}
        {...props}
    >
...
/** In-app alerts — header notifications */
...
/** Internal team DM — header Team Chat */
...
/** Attachment (paperclip) — chat composer */
...
/** Stop recording — chat composer */
export const SquareFillIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
/** Help circle – used for Support Center */
