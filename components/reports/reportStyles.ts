...
export const reportTableChrome =
  'overflow-x-auto rounded-xl border border-gray-100/90 dark:border-gray-700/80 bg-gray-50/40 dark:bg-gray-950/30';

export const reportTheadRow =
  'text-[11px] font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300 bg-gradient-to-r from-gray-50 to-indigo-50/35 dark:from-gray-800/95 dark:to-primary-950/25 border-b border-gray-200/80 dark:border-gray-700';

export const reportTbodyCell =
  'px-4 py-3.5 whitespace-nowrap text-center text-sm text-gray-900 dark:text-gray-100';
