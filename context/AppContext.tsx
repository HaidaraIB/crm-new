    ...
    setCurrentUserState((prev) => {
      ...
      localStorage.setItem('currentUser', JSON.stringify({
        ...
        company: merged.company ? {
          ...
          no_follow_up_enabled: merged.company.no_follow_up_enabled,
          no_follow_up_hours: merged.company.no_follow_up_hours,
          no_follow_up_digest_hour: merged.company.no_follow_up_digest_hour,
