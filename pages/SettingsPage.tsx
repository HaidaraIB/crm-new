...
type SettingsTab = 'Channels' | 'Stages' | 'Statuses' | 'CallMethods' | 'LeadAssignment';
...
export const SettingsPage = () => {
    ...
    const [activeTab, setActiveTab] = useState<SettingsTab>(() => {
        ...
        return savedTab && ['Channels', 'Stages', 'Statuses', 'CallMethods', 'LeadAssignment'].includes(savedTab) ? savedTab : 'Channels';
    });
